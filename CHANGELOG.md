...
## [1.2.0](https://github.com/git-dmitriy/game2048/compare/v1.1.2...v1.2.0) (2026-06-30)


### Fixed

* **audio:** unlock audio on touchstart without blocking board input ([78f2c70](https://github.com/git-dmitriy/game2048/commit/78f2c703da8eda4303d70bb0c029e76359b71de4))
* **input:** pause board controls while settings are open ([340e57e](https://github.com/git-dmitriy/game2048/commit/340e57e72bb740fde3750a07bd9249d469d74763))


### Added

* **pwa:** add Chromium install prompt via beforeinstallprompt ([e8edf65](https://github.com/git-dmitriy/game2048/commit/e8edf655dc1f16f330adfadc38a88b872211ee6d))

### [1.1.2](https://github.com/git-dmitriy/game2048/compare/v1.1.1...v1.1.2) (2026-06-25)


### Fixed

* **pwa:** silent cold-start updates, in-session prompt, 60m background apply ([5da6357](https://github.com/git-dmitriy/game2048/commit/5da63575ad7b2659fb1b7d8677bd840698326ea3))
