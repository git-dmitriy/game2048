...
* **pwa:** Chromium install prompt via `beforeinstallprompt` (Android and desktop Chrome)

### Fixed

* **ios:** unlock audio on touchstart without blocking board input; sound independent of reduced motion
